...
export const zhHant = defineLocale({
  ...
  kanban: {
    ...
    orchestration: {
      ...
      loadingMode: "正在載入模式…",
      autoModeTitle:
        "編排：自動 — 調度器會在每次 tick 自動拆解新的待分類任務。點擊切換到手動模式。",
      manualModeTitle:
        "編排：手動 — 待分類任務會留在待分類欄，直到你在卡片上點擊 ⚗ 拆解。點擊切換到自動模式。",
      configureTitle:
        "設定看板編排器（編排器設定、預設負責人、自動拆解、設定描述）",
      reload: "重新載入",
      orchestratorProfile: "編排器設定",
      defaultProfile: "（預設：{profile}）",
      resolved: "目前：{profile}",
      orchestratorHelp:
        "在扇出後擁有根任務（會被喚醒來判斷完成情況）。它不決定任務如何拆分；拆解模型請在 auxiliary.kanban_decomposer 中設定。",
      defaultAssignee: "預設負責人",
      mode: "編排模式",
      autoDecompose: "自動拆解待分類任務",
      autoDecomposeHelp: "調度器會自動拆解新的待分類任務。",
      manualDecomposeHelp: "待分類任務會留在待分類欄，直到你點擊 ⚗ 拆解。",
      loading: "載入中…",
      profileDescriptions: "設定描述",
      profileDescriptionsHelp:
        "描述會指引拆解器的路由。點擊 ⚗ 自動產生，或手動編輯後儲存。",
      noProfiles: "沒有安裝任何設定。",
      defaultTag: "（預設）",
      autoReview: "自動 — 待檢查",
      noDescriptionWarning: "⚠ 無描述",
      descriptionPlaceholder: "這個設定擅長什麼？",
      saveDescriptionTitle: "將上方描述儲存為使用者撰寫內容",
      save: "儲存",
      saving: "儲存中…",
      autoDescriptionTitle: "根據此設定的技能和模型自動產生描述",
      autoButton: "⚗ 自動",
      generating: "產生中…",
      failedToLoad: "載入失敗：{message}",
      settingsSaved: "設定已儲存。",
      saveFailed: "儲存失敗：{message}",
      descriptionSaved: "已儲存 {name} 的描述。",
      autoGenerated: "已為 {name} 自動產生描述。",
      autoGenerateFailed: "自動產生失敗：{message}",
      unknownError: "未知錯誤",
    },
    columnLabels: {
      triage: "待分類",
